...
<nav class="navbar">
    ...
    <ul>
        ...
        <li><a href="airing.php">Top Airing</a></li>
...
curl_setopt_array($curl, [
    CURLOPT_URL => "https://scappperanime.p.rapidapi.com/popular?page=1",
    ...
    CURLOPT_HTTPHEADER => [
        ...
        "X-RapidAPI-Key: a8fce8344fmsh9dbe2c61adce89bp12ff93jsnf7a2dfcd4ba8"
    ],
]);
...
if ($err) {
    ...
    if (isset($data['anime']) && is_array($data['anime'])) {
